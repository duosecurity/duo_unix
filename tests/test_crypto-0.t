Testing if fips complient
  $ chmod +x ${BUILDDIR}/fips_scanner.sh
  $ ${BUILDDIR}/fips_scanner.sh ${BUILDDIR}/lib
  Starting scan ...
  Scanning directory
  ...
  $ ${BUILDDIR}/fips_scanner.sh ${BUILDDIR}/login_duo
  Starting scan ...
  Scanning directory
  ...
  $ ${BUILDDIR}/fips_scanner.sh ${BUILDDIR}/pam_duo
  Starting scan ...
  Scanning directory
  ...
  $ ${BUILDDIR}/fips_scanner.sh ${BUILDDIR}/autotools
  Starting scan ...
  Scanning directory
